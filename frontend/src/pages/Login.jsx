    ...
    return (
        <div className="flex min-h-screen w-full">
            ...
            <div className="flex flex-col w-full lg:w-1/2 justify-center items-center p-6 sm:p-12 md:p-20 bg-[#f5f8f8]">
                ...
                {/* Card */}
                <div className="w-full max-w-110 bg-white p-8 md:p-10 rounded-2xl shadow-xl shadow-primary/5 border border-[#e5edee]">
                    ...
                    <div className="flex flex-col items-center mb-8">
                        <div className="-mt-6 mb-4">
                            <img
                                src="/nombre.png"
                                alt="Café Mirador Pululahua Lounge"
                    ...
                    <form className="space-y-5" onSubmit={handleSubmit}>
                        ...
                        <div className="relative flex items-center py-2">
                            <div className="grow border-t border-[#dae6e7]" />
                            <span className="shrink mx-4 text-xs font-medium text-[#5e8a8d] uppercase tracking-wider">
                                O continúa con
                            </span>
                            <div className="grow border-t border-[#dae6e7]" />
                        </div>
