    ...
    return (
        ...
        <div className="flex flex-1 flex-col items-center justify-center px-6 py-12 lg:px-20 bg-[#f5f8f8]">
            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
                ...
                <label className="text-sm font-semibold text-[#111818] ml-1">Nombre Completo</label>
                <input
                    name="nombre" type="text" placeholder="Ingresa tu Nombre Completo"
                ...
                {/* Email */}
                <div className="flex flex-col gap-2">
                <label className="text-sm font-semibold text-[#111818] ml-1">Correo Electrónico</label>
                <input
                    name="email" type="email" placeholder="Ingresa tu Correo Electrónico"
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <input
                    name="cedula" type="text" placeholder="Ingresa tu Cédula"
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <input
                    name="celular" type="tel" placeholder="Ingresa tu Celular"
                ...
                <input
                    name="direccion" type="text" placeholder="Ingresa tu Dirección de Domicilio"
                ...
                <div className="flex flex-col gap-2">
                <label className="text-sm font-semibold text-[#111818] ml-1">Confirmar Contraseña</label>
                <div className="relative flex items-center">
                    <input
